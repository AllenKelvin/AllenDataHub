...
const formatWhatsAppTarget = (value?: string) => {
  if (!value) return "";
...
export function PublicMiniStore({ slug }: { slug: string }) {
  ...
  useEffect(() => {
    ...
    const description = `${storeName} offers a simple shopping experience with fast delivery and reliable service.`;
